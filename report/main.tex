...
\begin{center}
    ...
    \textsc{\LARGE High Capacity Transmission}\\[2.0cm]
    \HRule\\[0.4cm]
    {\large \bf {Source coding and combination of error-correcting codes.}}\\[0.2cm]
    \HRule\\[1.5cm]
\end{center}
...
\begin{center}
    ...
    \begin{minipage}{0.5\textwidth}
        \begin{flushright}
            ...
            \href{mailto:s.bartolo@campus.fct.unl.pt}{\texttt{md.agostinho@campus.fct.unl.pt}}\\
            \href{mailto:fsc.costa@campus.fct.unl.pt}{\texttt{lorem.ipsum@campus.fct.unl.pt}}
        \end{flushright}
    \end{minipage}
\end{center}
