...
%1e6 bits hufman
n_huffman = ceil(1e6 / numel(encodedMessage_huffman));

%1e6 bits ascii
n_ascii = ceil(1e6 / numel(bitStream_ascii));

%meter 16qam, ofdm, passar pelo canal e sacar tudo de fora


%decoding 1e6 huffman
decodedSignal_huffman   = huffmandeco(encodedMessage_huffman,dict_huffman);
